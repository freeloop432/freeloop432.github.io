!function () {
    ...
    function e(n, e) {
        ...
        var t, a = function (n, e) {
            ...
            return t
        }(n, e), n = (e = e, (t = {}).x = n, t.y = e, t.color = c[anime.random(0, c.length - 1)], t.color = "#FFF", t.radius = 0, t.alpha = 1, t.lineWidth = 6, t.draw = function () {
            ...
            targets: n,
            radius: function () {
                return anime.random(24 * o(), 32 * o())
            },
            lineWidth: 0,
            alpha: {value: 0, easing: "linear", duration: function () {
    ...
    var t, a, o = function () {
        ...
        }, n = document.getElementById("fireworks"), u = n.getContext("2d"), d = [],
